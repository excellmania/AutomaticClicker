.class synthetic Landroid/arch/lifecycle/h$1;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/arch/lifecycle/h$1;->b:[I

    const/4 v0, 0x1

    :try_start_0
    sget-object v1, Landroid/arch/lifecycle/h$1;->b:[I

    sget-object v2, Landroid/arch/lifecycle/d$b;->b:Landroid/arch/lifecycle/d$b;

    invoke-virtual {v2}, Landroid/arch/lifecycle/d$b;->ordinal()I
    ...
    :try_start_1
    sget-object v2, Landroid/arch/lifecycle/h$1;->b:[I

    sget-object v3, Landroid/arch/lifecycle/d$b;->c:Landroid/arch/lifecycle/d$b;

    invoke-virtual {v3}, Landroid/arch/lifecycle/d$b;->ordinal()I
    ...
    :try_start_2
    sget-object v3, Landroid/arch/lifecycle/h$1;->b:[I

    sget-object v4, Landroid/arch/lifecycle/d$b;->d:Landroid/arch/lifecycle/d$b;

    invoke-virtual {v4}, Landroid/arch/lifecycle/d$b;->ordinal()I
    ...
    :try_start_3
    sget-object v4, Landroid/arch/lifecycle/h$1;->b:[I

    sget-object v5, Landroid/arch/lifecycle/d$b;->e:Landroid/arch/lifecycle/d$b;

    invoke-virtual {v5}, Landroid/arch/lifecycle/d$b;->ordinal()I
    ...
    :try_start_4
    sget-object v5, Landroid/arch/lifecycle/h$1;->b:[I

    sget-object v6, Landroid/arch/lifecycle/d$b;->a:Landroid/arch/lifecycle/d$b;

    invoke-virtual {v6}, Landroid/arch/lifecycle/d$b;->ordinal()I
    ...
    sput-object v5, Landroid/arch/lifecycle/h$1;->a:[I

    :try_start_5
    sget-object v5, Landroid/arch/lifecycle/h$1;->a:[I

    sget-object v6, Landroid/arch/lifecycle/d$a;->ON_CREATE:Landroid/arch/lifecycle/d$a;

    invoke-virtual {v6}, Landroid/arch/lifecycle/d$a;->ordinal()I
    ...
    invoke-virtual {v5}, Landroid/arch/lifecycle/d$a;->ordinal()I
    ...
    invoke-virtual {v1}, Landroid/arch/lifecycle/d$a;->ordinal()I
