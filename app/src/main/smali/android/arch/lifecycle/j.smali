...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/arch/lifecycle/j;->a:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, Landroid/arch/lifecycle/j;->b:Ljava/util/Map;
...
.method static a(Ljava/lang/Object;)Landroid/arch/lifecycle/GenericLifecycleObserver;
    ...
    invoke-static {v0}, Landroid/arch/lifecycle/j;->b(Ljava/lang/Class;)I
    ...
    sget-object v1, Landroid/arch/lifecycle/j;->b:Ljava/util/Map;
    ...
    invoke-static {v0, p0}, Landroid/arch/lifecycle/j;->a(Ljava/lang/reflect/Constructor;Ljava/lang/Object;)Landroid/arch/lifecycle/c;
    ...
    invoke-static {v3, p0}, Landroid/arch/lifecycle/j;->a(Ljava/lang/reflect/Constructor;Ljava/lang/Object;)Landroid/arch/lifecycle/c;
...
.method private static a(Ljava/lang/Class;)Ljava/lang/reflect/Constructor;
    ...
    :goto_1
    invoke-static {v1}, Landroid/arch/lifecycle/j;->a(Ljava/lang/String;)Ljava/lang/String;
...
.method private static b(Ljava/lang/Class;)I
    ...
    sget-object v0, Landroid/arch/lifecycle/j;->a:Ljava/util/Map;
    ...
    :cond_0
    invoke-static {p0}, Landroid/arch/lifecycle/j;->c(Ljava/lang/Class;)I

    move-result v0

    sget-object v1, Landroid/arch/lifecycle/j;->a:Ljava/util/Map;
...
.method private static c(Ljava/lang/Class;)I
    ...
    :cond_0
    invoke-static {p0}, Landroid/arch/lifecycle/j;->a(Ljava/lang/Class;)Ljava/lang/reflect/Constructor;
    ...
    invoke-static {v0}, Landroid/arch/lifecycle/j;->d(Ljava/lang/Class;)Z
    ...
    sget-object v4, Landroid/arch/lifecycle/j;->b:Ljava/util/Map;
    ...
    invoke-static {v6}, Landroid/arch/lifecycle/j;->d(Ljava/lang/Class;)Z
    ...
    :cond_5
    invoke-static {v6}, Landroid/arch/lifecycle/j;->b(Ljava/lang/Class;)I
    ...
    :cond_7
    sget-object v7, Landroid/arch/lifecycle/j;->b:Ljava/util/Map;
    ...
    sget-object v0, Landroid/arch/lifecycle/j;->b:Ljava/util/Map;
