...
.method private a(Ljava/lang/Class;[Ljava/lang/reflect/Method;)Landroid/arch/lifecycle/a$a;
    ...
    check-cast v6, Landroid/arch/lifecycle/d$a;

    invoke-direct {p0, v1, v7, v6, p1}, Landroid/arch/lifecycle/a;->a(Ljava/util/Map;Landroid/arch/lifecycle/a$b;Landroid/arch/lifecycle/d$a;Ljava/lang/Class;)V
    ...
    const-class v6, Landroid/arch/lifecycle/n;
    ...
    const-class v9, Landroid/arch/lifecycle/g;
    ...
    :goto_4
    invoke-interface {v6}, Landroid/arch/lifecycle/n;->a()Landroid/arch/lifecycle/d$a;
    ...
    const-class v9, Landroid/arch/lifecycle/d$a;
    ...
    sget-object v8, Landroid/arch/lifecycle/d$a;->ON_ANY:Landroid/arch/lifecycle/d$a;
    ...
    invoke-direct {p0, v1, v4, v6, p1}, Landroid/arch/lifecycle/a;->a(Ljava/util/Map;Landroid/arch/lifecycle/a$b;Landroid/arch/lifecycle/d$a;Ljava/lang/Class;)V
...
.method private a(Ljava/util/Map;Landroid/arch/lifecycle/a$b;Landroid/arch/lifecycle/d$a;Ljava/lang/Class;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method a(Ljava/lang/Class;)Z
    ...
    const-class v5, Landroid/arch/lifecycle/n;
