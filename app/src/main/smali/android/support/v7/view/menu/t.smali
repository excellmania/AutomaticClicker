...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v7/view/menu/h;Landroid/view/View;IIZ)V
    ...
    new-instance p3, Landroid/support/v7/widget/aq;
    ...
    invoke-direct {p3, p4, v0, p5, p6}, Landroid/support/v7/widget/aq;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iput-object p3, p0, Landroid/support/v7/view/menu/t;->a:Landroid/support/v7/widget/aq;
...
.method private h()Z
    ...
    iget-object v3, p0, Landroid/support/v7/view/menu/t;->a:Landroid/support/v7/widget/aq;

    invoke-virtual {v3, v0}, Landroid/support/v7/widget/aq;->b(Landroid/view/View;)V

    iget-object v0, p0, Landroid/support/v7/view/menu/t;->a:Landroid/support/v7/widget/aq;

    iget v3, p0, Landroid/support/v7/view/menu/t;->t:I

    invoke-virtual {v0, v3}, Landroid/support/v7/widget/aq;->e(I)V
    ...
    invoke-virtual {v0, v4}, Landroid/support/v7/widget/aq;->g(I)V

    iget-object v0, p0, Landroid/support/v7/view/menu/t;->a:Landroid/support/v7/widget/aq;

    const/4 v4, 0x2

    invoke-virtual {v0, v4}, Landroid/support/v7/widget/aq;->h(I)V
    ...
    invoke-virtual {v0, v4}, Landroid/support/v7/widget/aq;->a(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/aq;->e()Landroid/widget/ListView;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/aq;->a(Landroid/widget/ListAdapter;)V
...
.method public a(Landroid/support/v7/view/menu/u;)Z
    ...
    invoke-virtual {v2}, Landroid/support/v7/widget/aq;->j()I

    move-result v2

    iget-object v3, p0, Landroid/support/v7/view/menu/t;->a:Landroid/support/v7/widget/aq;

    invoke-virtual {v3}, Landroid/support/v7/widget/aq;->k()I
    ...
    invoke-static {v5}, Landroid/support/v4/h/s;->e(Landroid/view/View;)I
