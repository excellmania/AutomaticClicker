...
.method private a(Landroid/view/MenuItem;)V
    ...
    invoke-static {p1, v0}, Landroid/support/v4/h/i;->a(Landroid/view/MenuItem;Landroid/support/v4/h/c;)Landroid/view/MenuItem;

    :cond_a
    iget-object v0, p0, Landroid/support/v7/view/g$b;->C:Ljava/lang/CharSequence;

    invoke-static {p1, v0}, Landroid/support/v4/h/i;->a(Landroid/view/MenuItem;Ljava/lang/CharSequence;)V

    iget-object v0, p0, Landroid/support/v7/view/g$b;->D:Ljava/lang/CharSequence;

    invoke-static {p1, v0}, Landroid/support/v4/h/i;->b(Landroid/view/MenuItem;Ljava/lang/CharSequence;)V

    iget-char v0, p0, Landroid/support/v7/view/g$b;->p:C

    iget v1, p0, Landroid/support/v7/view/g$b;->q:I

    invoke-static {p1, v0, v1}, Landroid/support/v4/h/i;->b(Landroid/view/MenuItem;CI)V

    iget-char v0, p0, Landroid/support/v7/view/g$b;->r:C

    iget v1, p0, Landroid/support/v7/view/g$b;->s:I

    invoke-static {p1, v0, v1}, Landroid/support/v4/h/i;->a(Landroid/view/MenuItem;CI)V

    iget-object v0, p0, Landroid/support/v7/view/g$b;->F:Landroid/graphics/PorterDuff$Mode;

    if-eqz v0, :cond_b

    invoke-static {p1, v0}, Landroid/support/v4/h/i;->a(Landroid/view/MenuItem;Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p1, v0}, Landroid/support/v4/h/i;->a(Landroid/view/MenuItem;Landroid/content/res/ColorStateList;)V
...
.method public b(Landroid/util/AttributeSet;)V
    ...
    invoke-static {v0, v2}, Landroid/support/v7/widget/ag;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
