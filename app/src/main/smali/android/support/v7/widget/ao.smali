...
.method static constructor <clinit>()V
    ...
    sput-object v2, Landroid/support/v7/widget/ao;->a:Ljava/lang/reflect/Method;
    :try_end_0
    ...
    sput-object v2, Landroid/support/v7/widget/ao;->b:Ljava/lang/reflect/Method;
    :try_end_1
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v1, v0}, Landroid/support/v7/widget/ao;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-boolean v0, p0, Landroid/support/v7/widget/ao;->q:Z

    const/4 v1, 0x0

    iput v1, p0, Landroid/support/v7/widget/ao;->t:I

    iput-boolean v1, p0, Landroid/support/v7/widget/ao;->u:Z

    iput-boolean v1, p0, Landroid/support/v7/widget/ao;->v:Z

    const v2, 0x7fffffff

    iput v2, p0, Landroid/support/v7/widget/ao;->d:I

    iput v1, p0, Landroid/support/v7/widget/ao;->x:I

    new-instance v2, Landroid/support/v7/widget/ao$e;

    invoke-direct {v2, p0}, Landroid/support/v7/widget/ao$e;-><init>(Landroid/support/v7/widget/ao;)V

    iput-object v2, p0, Landroid/support/v7/widget/ao;->e:Landroid/support/v7/widget/ao$e;

    new-instance v2, Landroid/support/v7/widget/ao$d;

    invoke-direct {v2, p0}, Landroid/support/v7/widget/ao$d;-><init>(Landroid/support/v7/widget/ao;)V

    iput-object v2, p0, Landroid/support/v7/widget/ao;->D:Landroid/support/v7/widget/ao$d;

    new-instance v2, Landroid/support/v7/widget/ao$c;

    invoke-direct {v2, p0}, Landroid/support/v7/widget/ao$c;-><init>(Landroid/support/v7/widget/ao;)V

    iput-object v2, p0, Landroid/support/v7/widget/ao;->E:Landroid/support/v7/widget/ao$c;
    ...
    iput-object v2, p0, Landroid/support/v7/widget/ao;->F:Landroid/support/v7/widget/ao$a;

    new-instance v2, Landroid/graphics/Rect;

    invoke-direct {v2}, Landroid/graphics/Rect;-><init>()V

    iput-object v2, p0, Landroid/support/v7/widget/ao;->H:Landroid/graphics/Rect;
    ...
    iput-object v2, p0, Landroid/support/v7/widget/ao;->f:Landroid/os/Handler;
    ...
    iput v3, p0, Landroid/support/v7/widget/ao;->m:I
    ...
    iput-object v1, p0, Landroid/support/v7/widget/ao;->g:Landroid/widget/PopupWindow;

    iget-object p1, p0, Landroid/support/v7/widget/ao;->g:Landroid/widget/PopupWindow;
...
.method private a(Landroid/view/View;IZ)I
    ...
    :cond_0
    iget-object p3, p0, Landroid/support/v7/widget/ao;->g:Landroid/widget/PopupWindow;
...
.method private f()I
    ...
    new-instance v5, Landroid/support/v7/widget/ao$1;

    invoke-direct {v5, p0}, Landroid/support/v7/widget/ao$1;-><init>(Landroid/support/v7/widget/ao;)V

    iput-object v5, p0, Landroid/support/v7/widget/ao;->G:Ljava/lang/Runnable;

    iget-boolean v5, p0, Landroid/support/v7/widget/ao;->J:Z

    xor-int/2addr v5, v3

    invoke-virtual {p0, v0, v5}, Landroid/support/v7/widget/ao;->a(Landroid/content/Context;Z)Landroid/support/v7/widget/ah;

    move-result-object v5

    iput-object v5, p0, Landroid/support/v7/widget/ao;->c:Landroid/support/v7/widget/ah;

    iget-object v5, p0, Landroid/support/v7/widget/ao;->A:Landroid/graphics/drawable/Drawable;

    if-eqz v5, :cond_0

    iget-object v6, p0, Landroid/support/v7/widget/ao;->c:Landroid/support/v7/widget/ah;

    invoke-virtual {v6, v5}, Landroid/support/v7/widget/ah;->setSelector(Landroid/graphics/drawable/Drawable;)V

    :cond_0
    iget-object v5, p0, Landroid/support/v7/widget/ao;->c:Landroid/support/v7/widget/ah;

    iget-object v6, p0, Landroid/support/v7/widget/ao;->j:Landroid/widget/ListAdapter;

    invoke-virtual {v5, v6}, Landroid/support/v7/widget/ah;->setAdapter(Landroid/widget/ListAdapter;)V

    iget-object v5, p0, Landroid/support/v7/widget/ao;->c:Landroid/support/v7/widget/ah;

    iget-object v6, p0, Landroid/support/v7/widget/ao;->B:Landroid/widget/AdapterView$OnItemClickListener;

    invoke-virtual {v5, v6}, Landroid/support/v7/widget/ah;->setOnItemClickListener(Landroid/widget/AdapterView$OnItemClickListener;)V

    iget-object v5, p0, Landroid/support/v7/widget/ao;->c:Landroid/support/v7/widget/ah;

    invoke-virtual {v5, v3}, Landroid/support/v7/widget/ah;->setFocusable(Z)V

    iget-object v5, p0, Landroid/support/v7/widget/ao;->c:Landroid/support/v7/widget/ah;

    invoke-virtual {v5, v3}, Landroid/support/v7/widget/ah;->setFocusableInTouchMode(Z)V
    ...
    invoke-virtual {v5, v6}, Landroid/support/v7/widget/ah;->setOnItemSelectedListener(Landroid/widget/AdapterView$OnItemSelectedListener;)V

    iget-object v5, p0, Landroid/support/v7/widget/ao;->c:Landroid/support/v7/widget/ah;

    iget-object v6, p0, Landroid/support/v7/widget/ao;->E:Landroid/support/v7/widget/ao$c;

    invoke-virtual {v5, v6}, Landroid/support/v7/widget/ah;->setOnScrollListener(Landroid/widget/AbsListView$OnScrollListener;)V

    iget-object v5, p0, Landroid/support/v7/widget/ao;->C:Landroid/widget/AdapterView$OnItemSelectedListener;

    if-eqz v5, :cond_1

    iget-object v6, p0, Landroid/support/v7/widget/ao;->c:Landroid/support/v7/widget/ah;

    invoke-virtual {v6, v5}, Landroid/support/v7/widget/ah;->setOnItemSelectedListener(Landroid/widget/AdapterView$OnItemSelectedListener;)V

    :cond_1
    iget-object v5, p0, Landroid/support/v7/widget/ao;->c:Landroid/support/v7/widget/ah;

    iget-object v6, p0, Landroid/support/v7/widget/ao;->w:Landroid/view/View;
    ...
    :goto_3
    iget-object v5, p0, Landroid/support/v7/widget/ao;->g:Landroid/widget/PopupWindow;
    ...
    iget-object v6, p0, Landroid/support/v7/widget/ao;->H:Landroid/graphics/Rect;
    ...
    iget-boolean v6, p0, Landroid/support/v7/widget/ao;->p:Z
    ...
    iput v6, p0, Landroid/support/v7/widget/ao;->n:I
    ...
    iget v6, p0, Landroid/support/v7/widget/ao;->n:I

    invoke-direct {p0, v4, v6, v3}, Landroid/support/v7/widget/ao;->a(Landroid/view/View;IZ)I

    move-result v3

    iget-boolean v4, p0, Landroid/support/v7/widget/ao;->u:Z
    ...
    :pswitch_2
    iget-object v1, p0, Landroid/support/v7/widget/ao;->i:Landroid/content/Context;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ao;->H:Landroid/graphics/Rect;
    ...
    :pswitch_3
    iget-object v2, p0, Landroid/support/v7/widget/ao;->i:Landroid/content/Context;
    ...
    invoke-virtual/range {v6 .. v11}, Landroid/support/v7/widget/ah;->a(IIIII)I
    ...
    invoke-virtual {v2}, Landroid/support/v7/widget/ah;->getPaddingTop()I

    move-result v2

    iget-object v3, p0, Landroid/support/v7/widget/ao;->c:Landroid/support/v7/widget/ah;

    invoke-virtual {v3}, Landroid/support/v7/widget/ah;->getPaddingBottom()I
...
.method public a()V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ao;->g:Landroid/widget/PopupWindow;
    ...
    invoke-static {v2}, Landroid/support/v4/h/s;->y(Landroid/view/View;)Z
    ...
    :cond_2
    :goto_0
    iget v7, p0, Landroid/support/v7/widget/ao;->k:I
    ...
    iget-boolean v4, p0, Landroid/support/v7/widget/ao;->v:Z
    ...
    iget-object v7, p0, Landroid/support/v7/widget/ao;->g:Landroid/widget/PopupWindow;

    invoke-virtual {p0}, Landroid/support/v7/widget/ao;->i()Landroid/view/View;

    move-result-object v8

    iget v9, p0, Landroid/support/v7/widget/ao;->m:I

    iget v10, p0, Landroid/support/v7/widget/ao;->n:I
    ...
    iget-boolean v1, p0, Landroid/support/v7/widget/ao;->v:Z

    if-nez v1, :cond_11

    iget-boolean v1, p0, Landroid/support/v7/widget/ao;->u:Z
    ...
    iget-object v3, p0, Landroid/support/v7/widget/ao;->I:Landroid/graphics/Rect;
...
.method public a(Landroid/widget/ListAdapter;)V
    ...
    :cond_2
    iget-object p1, p0, Landroid/support/v7/widget/ao;->c:Landroid/support/v7/widget/ah;

    if-eqz p1, :cond_3

    iget-object v0, p0, Landroid/support/v7/widget/ao;->j:Landroid/widget/ListAdapter;

    invoke-virtual {p1, v0}, Landroid/support/v7/widget/ah;->setAdapter(Landroid/widget/ListAdapter;)V
