...
.method private a(Landroid/support/v7/widget/RecyclerView;)I
    ...
    sget v0, Landroid/support/v7/d/a$a;->item_touch_helper_max_drag_scroll_per_frame:I
...
.method public a(Landroid/support/v7/widget/RecyclerView$x;Ljava/util/List;II)Landroid/support/v7/widget/RecyclerView$x;
    ...
    iget-object v7, v10, Landroid/support/v7/widget/RecyclerView$x;->a:Landroid/view/View;
...
.method public a(Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$x;ILandroid/support/v7/widget/RecyclerView$x;III)V
    ...
    :cond_0
    invoke-virtual {p3}, Landroid/support/v7/widget/RecyclerView$i;->e()Z
    ...
    invoke-virtual {p3, p2}, Landroid/support/v7/widget/RecyclerView$i;->h(Landroid/view/View;)I
    ...
    invoke-virtual {p3, p2}, Landroid/support/v7/widget/RecyclerView$i;->j(Landroid/view/View;)I
    ...
    :cond_2
    invoke-virtual {p3}, Landroid/support/v7/widget/RecyclerView$i;->f()Z
    ...
    invoke-virtual {p3, p2}, Landroid/support/v7/widget/RecyclerView$i;->i(Landroid/view/View;)I
    ...
    invoke-virtual {p3, p2}, Landroid/support/v7/widget/RecyclerView$i;->k(Landroid/view/View;)I
