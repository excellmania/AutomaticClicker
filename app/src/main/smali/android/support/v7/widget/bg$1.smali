...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroid/support/v7/widget/bg;-><init>(Landroid/support/v7/widget/Toolbar;ZII)V
.end annotation
...
.method constructor <init>(Landroid/support/v7/widget/bg;)V
    ...
    iget-object v0, v0, Landroid/support/v7/widget/bg;->a:Landroid/support/v7/widget/Toolbar;
    ...
    iget-object v6, v0, Landroid/support/v7/widget/bg;->b:Ljava/lang/CharSequence;
    ...
    iput-object p1, p0, Landroid/support/v7/widget/bg$1;->a:Landroid/support/v7/view/menu/a;
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object p1, p0, Landroid/support/v7/widget/bg$1;->b:Landroid/support/v7/widget/bg;

    iget-object p1, p1, Landroid/support/v7/widget/bg;->c:Landroid/view/Window$Callback;

    if-eqz p1, :cond_0

    iget-object p1, p0, Landroid/support/v7/widget/bg$1;->b:Landroid/support/v7/widget/bg;

    iget-boolean p1, p1, Landroid/support/v7/widget/bg;->d:Z
    ...
    iget-object v1, p0, Landroid/support/v7/widget/bg$1;->a:Landroid/support/v7/view/menu/a;
