...
.method private b(Landroid/graphics/drawable/Drawable;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/g;->f:Landroid/support/v7/widget/bd;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/g;->f:Landroid/support/v7/widget/bd;
    ...
    invoke-static {v1}, Landroid/support/v4/h/s;->r(Landroid/view/View;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v1}, Landroid/support/v4/h/s;->s(Landroid/view/View;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v1

    if-eqz v1, :cond_2

    iput-boolean v2, v0, Landroid/support/v7/widget/bd;->c:Z

    iput-object v1, v0, Landroid/support/v7/widget/bd;->b:Landroid/graphics/PorterDuff$Mode;

    :cond_2
    iget-boolean v1, v0, Landroid/support/v7/widget/bd;->d:Z

    if-nez v1, :cond_4

    iget-boolean v1, v0, Landroid/support/v7/widget/bd;->c:Z
    ...
    invoke-static {p1, v0, v1}, Landroid/support/v7/widget/l;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bd;[I)V
...
.method private d()Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/g;->d:Landroid/support/v7/widget/bd;
...
.method a()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/g;->e:Landroid/support/v7/widget/bd;
...
.method a(Landroid/content/res/ColorStateList;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/g;->e:Landroid/support/v7/widget/bd;
    ...
    iput-boolean p1, v0, Landroid/support/v7/widget/bd;->d:Z
...
.method a(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iput-boolean p1, v0, Landroid/support/v7/widget/bd;->c:Z
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {p1, p2}, Landroid/support/v7/widget/bf;->g(I)Z
    ...
    invoke-virtual {p1, p2, v0}, Landroid/support/v7/widget/bf;->g(II)I
    ...
    invoke-virtual {p1, v1}, Landroid/support/v7/widget/bf;->e(I)Landroid/content/res/ColorStateList;

    move-result-object v1

    invoke-static {p2, v1}, Landroid/support/v4/h/s;->a(Landroid/view/View;Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {p1, v1, v0}, Landroid/support/v7/widget/bf;->a(II)I

    move-result v0

    const/4 v1, 0x0

    invoke-static {v0, v1}, Landroid/support/v7/widget/ag;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v0

    invoke-static {p2, v0}, Landroid/support/v4/h/s;->a(Landroid/view/View;Landroid/graphics/PorterDuff$Mode;)V
    :try_end_0
...
.method b(Landroid/content/res/ColorStateList;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/g;->d:Landroid/support/v7/widget/bd;
    ...
    iput-object p1, p0, Landroid/support/v7/widget/g;->d:Landroid/support/v7/widget/bd;
...
.method c()V
    ...
    :cond_0
    iget-object v1, p0, Landroid/support/v7/widget/g;->e:Landroid/support/v7/widget/bd;
    ...
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/g;->d:Landroid/support/v7/widget/bd;
