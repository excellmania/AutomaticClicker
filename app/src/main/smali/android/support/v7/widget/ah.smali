...
# instance fields
.field a:Landroid/support/v7/widget/ah$b;
...
.field private m:Landroid/support/v4/h/w;
...
.method constructor <init>(Landroid/content/Context;Z)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/ah;->b:Landroid/graphics/Rect;
    ...
    iput-boolean p2, p0, Landroid/support/v7/widget/ah;->k:Z

    invoke-virtual {p0, p1}, Landroid/support/v7/widget/ah;->setCacheColorHint(I)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/ah;->h:Ljava/lang/reflect/Field;

    iget-object p1, p0, Landroid/support/v7/widget/ah;->h:Ljava/lang/reflect/Field;
...
.method private a()V
    ...
    invoke-direct {p0}, Landroid/support/v7/widget/ah;->c()Z
...
.method private a(ILandroid/view/View;)V
    ...
    :cond_1
    invoke-direct {p0, p1, p2}, Landroid/support/v7/widget/ah;->b(ILandroid/view/View;)V

    if-eqz v3, :cond_3

    iget-object p1, p0, Landroid/support/v7/widget/ah;->b:Landroid/graphics/Rect;
...
.method private a(ILandroid/view/View;FF)V
    ...
    invoke-direct {p0, p1, p2}, Landroid/support/v7/widget/ah;->a(ILandroid/view/View;)V
...
.method private a(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ah;->b:Landroid/graphics/Rect;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ah;->b:Landroid/graphics/Rect;
...
.method private a(Landroid/view/View;IFF)V
    ...
    iput-boolean v0, p0, Landroid/support/v7/widget/ah;->l:Z
    ...
    iget v1, p0, Landroid/support/v7/widget/ah;->g:I
    ...
    :cond_2
    iput p2, p0, Landroid/support/v7/widget/ah;->g:I
    ...
    :cond_4
    invoke-direct {p0, p2, p1, p3, p4}, Landroid/support/v7/widget/ah;->a(ILandroid/view/View;FF)V

    invoke-direct {p0, v4}, Landroid/support/v7/widget/ah;->setSelectorEnabled(Z)V
...
.method private b()V
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/v7/widget/ah;->m:Landroid/support/v4/h/w;

    if-eqz v0, :cond_1

    invoke-virtual {v0}, Landroid/support/v4/h/w;->b()V

    const/4 v0, 0x0

    iput-object v0, p0, Landroid/support/v7/widget/ah;->m:Landroid/support/v4/h/w;
...
.method private b(ILandroid/view/View;)V
    ...
    iget-object p2, p0, Landroid/support/v7/widget/ah;->h:Ljava/lang/reflect/Field;
...
.method private c()Z
    ...
    iget-boolean v0, p0, Landroid/support/v7/widget/ah;->l:Z
...
.method public a(Landroid/view/MotionEvent;I)Z
    ...
    invoke-virtual {p0, v4, p2}, Landroid/support/v7/widget/ah;->pointToPosition(II)I
    ...
    invoke-virtual {p0, v3}, Landroid/support/v7/widget/ah;->getChildAt(I)Landroid/view/View;
    ...
    invoke-direct {p0, v3, v5, v4, p2}, Landroid/support/v7/widget/ah;->a(Landroid/view/View;IFF)V

    if-ne v0, v2, :cond_0

    invoke-direct {p0, v3, v5}, Landroid/support/v7/widget/ah;->a(Landroid/view/View;I)V
    ...
    iget-object p2, p0, Landroid/support/v7/widget/ah;->n:Landroid/support/v4/widget/i;
    ...
    iput-object p2, p0, Landroid/support/v7/widget/ah;->n:Landroid/support/v4/widget/i;
    ...
    :cond_6
    iget-object p1, p0, Landroid/support/v7/widget/ah;->n:Landroid/support/v4/widget/i;
...
.method protected drawableStateChanged()V
    ...
    invoke-direct {p0, v0}, Landroid/support/v7/widget/ah;->setSelectorEnabled(Z)V
...
.method public hasFocus()Z
    ...
    iget-boolean v0, p0, Landroid/support/v7/widget/ah;->k:Z
...
.method protected onDetachedFromWindow()V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ah;->a:Landroid/support/v7/widget/ah$b;
...
.method public onHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    iput-object v1, p0, Landroid/support/v7/widget/ah;->a:Landroid/support/v7/widget/ah$b;

    iget-object v1, p0, Landroid/support/v7/widget/ah;->a:Landroid/support/v7/widget/ah$b;

    invoke-virtual {v1}, Landroid/support/v7/widget/ah$b;->b()V
    ...
    :cond_2
    invoke-virtual {p0, v3}, Landroid/support/v7/widget/ah;->setSelection(I)V
    ...
    invoke-virtual {p0, v0, p1}, Landroid/support/v7/widget/ah;->pointToPosition(II)I

    move-result p1

    if-eq p1, v3, :cond_5

    invoke-virtual {p0}, Landroid/support/v7/widget/ah;->getSelectedItemPosition()I
    ...
    invoke-virtual {p0, p1, v0}, Landroid/support/v7/widget/ah;->setSelectionFromTop(II)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iput v0, p0, Landroid/support/v7/widget/ah;->g:I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/ah$b;->a()V
...
.method setListSelectionHidden(Z)V
    ...
    iput-boolean p1, p0, Landroid/support/v7/widget/ah;->j:Z
