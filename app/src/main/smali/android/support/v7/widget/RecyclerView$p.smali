...
.method private e(Landroid/support/v7/widget/RecyclerView$x;)V
    ...
    invoke-static {v0}, Landroid/support/v4/h/s;->d(Landroid/view/View;)I
    ...
    invoke-static {v0, v1}, Landroid/support/v4/h/s;->a(Landroid/view/View;I)V

    :cond_0
    invoke-static {v0}, Landroid/support/v4/h/s;->a(Landroid/view/View;)Z
    ...
    invoke-virtual {p1}, Landroid/support/v7/widget/at;->c()Landroid/support/v4/h/b;

    move-result-object p1

    invoke-static {v0, p1}, Landroid/support/v4/h/s;->a(Landroid/view/View;Landroid/support/v4/h/b;)V
...
.method a(IZJ)Landroid/support/v7/widget/RecyclerView$x;
    ...
    invoke-virtual {v1}, Landroid/support/v7/widget/RecyclerView$x;->v()V
    ...
    invoke-static {v5}, Landroid/support/v7/widget/RecyclerView;->j(Landroid/view/View;)Landroid/support/v7/widget/RecyclerView;
    ...
    invoke-virtual {v10}, Landroid/support/v7/widget/RecyclerView$x;->u()Ljava/util/List;
    ...
    invoke-virtual {v10}, Landroid/support/v7/widget/RecyclerView$x;->n()Z
...
.method a(JIZ)Landroid/support/v7/widget/RecyclerView$x;
    ...
    invoke-virtual {v2}, Landroid/support/v7/widget/RecyclerView$x;->g()J
...
.method a(Landroid/support/v7/widget/RecyclerView$x;Z)V
    ...
    invoke-static {v0, v2}, Landroid/support/v4/h/s;->a(Landroid/view/View;Landroid/support/v4/h/b;)V
...
.method b(IZ)Landroid/support/v7/widget/RecyclerView$x;
    ...
    iget-object p2, p2, Landroid/support/v7/widget/RecyclerView;->f:Landroid/support/v7/widget/ac;

    invoke-virtual {p2, v0}, Landroid/support/v7/widget/ac;->e(Landroid/view/View;)V

    iget-object p2, p0, Landroid/support/v7/widget/RecyclerView$p;->f:Landroid/support/v7/widget/RecyclerView;

    iget-object p2, p2, Landroid/support/v7/widget/RecyclerView;->f:Landroid/support/v7/widget/ac;

    invoke-virtual {p2, v0}, Landroid/support/v7/widget/ac;->b(Landroid/view/View;)I
    ...
    invoke-virtual {v1, p2}, Landroid/support/v7/widget/ac;->e(I)V
    ...
    invoke-virtual {v2}, Landroid/support/v7/widget/RecyclerView$x;->n()Z
...
.method b(Landroid/support/v7/widget/RecyclerView$x;)V
    ...
    invoke-virtual {v4, v5}, Landroid/support/v7/widget/al$a;->a(I)Z
    ...
    iget-object v5, v5, Landroid/support/v7/widget/RecyclerView;->B:Landroid/support/v7/widget/al$a;

    invoke-virtual {v5, v4}, Landroid/support/v7/widget/al$a;->a(I)Z
    ...
    iget-object v2, v2, Landroid/support/v7/widget/RecyclerView;->g:Landroid/support/v7/widget/bm;

    invoke-virtual {v2, p1}, Landroid/support/v7/widget/bm;->g(Landroid/support/v7/widget/RecyclerView$x;)V
...
.method d()V
    ...
    iget-object v0, v0, Landroid/support/v7/widget/RecyclerView;->B:Landroid/support/v7/widget/al$a;
...
.method d(Landroid/support/v7/widget/RecyclerView$x;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/bm;->g(Landroid/support/v7/widget/RecyclerView$x;)V
