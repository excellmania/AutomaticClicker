...
.method public constructor <init>(Landroid/support/v7/widget/ax;Landroid/content/Context;Landroid/support/v7/app/a$c;Z)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/ax$c;->b:[I

    iput-object p3, p0, Landroid/support/v7/widget/ax$c;->c:Landroid/support/v7/app/a$c;

    iget-object p1, p0, Landroid/support/v7/widget/ax$c;->b:[I

    sget p3, Landroid/support/v7/a/a$a;->actionBarTabStyle:I

    invoke-static {p2, v0, p1, p3, v1}, Landroid/support/v7/widget/bf;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/bf;

    move-result-object p1

    invoke-virtual {p1, v1}, Landroid/support/v7/widget/bf;->g(I)Z

    move-result p2

    if-eqz p2, :cond_0

    invoke-virtual {p1, v1}, Landroid/support/v7/widget/bf;->a(I)Landroid/graphics/drawable/Drawable;

    move-result-object p2

    invoke-virtual {p0, p2}, Landroid/support/v7/widget/ax$c;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/ax$c;->setGravity(I)V
...
.method public a()V
    ...
    :cond_0
    invoke-virtual {p0, v1}, Landroid/support/v7/widget/ax$c;->addView(Landroid/view/View;)V
    ...
    :cond_3
    iget-object v1, p0, Landroid/support/v7/widget/ax$c;->f:Landroid/view/View;

    if-eqz v1, :cond_4

    invoke-virtual {p0, v1}, Landroid/support/v7/widget/ax$c;->removeView(Landroid/view/View;)V

    iput-object v3, p0, Landroid/support/v7/widget/ax$c;->f:Landroid/view/View;
    ...
    iget-object v8, p0, Landroid/support/v7/widget/ax$c;->e:Landroid/widget/ImageView;
    ...
    invoke-virtual {p0, v8, v6}, Landroid/support/v7/widget/ax$c;->addView(Landroid/view/View;I)V

    iput-object v8, p0, Landroid/support/v7/widget/ax$c;->e:Landroid/widget/ImageView;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ax$c;->e:Landroid/widget/ImageView;
    ...
    invoke-virtual {p0, v2}, Landroid/support/v7/widget/ax$c;->addView(Landroid/view/View;)V

    iput-object v2, p0, Landroid/support/v7/widget/ax$c;->d:Landroid/widget/TextView;
...
.method public onMeasure(II)V
    ...
    iget-object p1, p0, Landroid/support/v7/widget/ax$c;->a:Landroid/support/v7/widget/ax;

    iget p1, p1, Landroid/support/v7/widget/ax;->c:I
...
.method public setSelected(Z)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/ax$c;->sendAccessibilityEvent(I)V
