...
.method constructor <init>(Landroid/support/v7/widget/ac$b;)V
    ...
    new-instance p1, Landroid/support/v7/widget/ac$a;

    invoke-direct {p1}, Landroid/support/v7/widget/ac$a;-><init>()V

    iput-object p1, p0, Landroid/support/v7/widget/ac;->b:Landroid/support/v7/widget/ac$a;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Landroid/support/v7/widget/ac;->c:Ljava/util/List;
...
.method private f(I)I
    ...
    invoke-interface {v1}, Landroid/support/v7/widget/ac$b;->a()I
    ...
    invoke-virtual {v3, v2}, Landroid/support/v7/widget/ac$a;->e(I)I
    ...
    :goto_1
    iget-object p1, p0, Landroid/support/v7/widget/ac;->b:Landroid/support/v7/widget/ac$a;

    invoke-virtual {p1, v2}, Landroid/support/v7/widget/ac$a;->c(I)Z
...
.method a()V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ac;->c:Ljava/util/List;
    ...
    invoke-interface {v1, v2}, Landroid/support/v7/widget/ac$b;->d(Landroid/view/View;)V
...
.method a(I)V
    ...
    invoke-virtual {v1, p1}, Landroid/support/v7/widget/ac$a;->d(I)Z

    move-result v1

    if-eqz v1, :cond_1

    invoke-direct {p0, v0}, Landroid/support/v7/widget/ac;->h(Landroid/view/View;)Z

    :cond_1
    iget-object v0, p0, Landroid/support/v7/widget/ac;->a:Landroid/support/v7/widget/ac$b;

    invoke-interface {v0, p1}, Landroid/support/v7/widget/ac$b;->a(I)V
...
.method a(Landroid/view/View;)V
    ...
    :cond_1
    iget-object p1, p0, Landroid/support/v7/widget/ac;->a:Landroid/support/v7/widget/ac$b;

    invoke-interface {p1, v0}, Landroid/support/v7/widget/ac$b;->a(I)V
...
.method a(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;Z)V
    ...
    iget-object p2, p0, Landroid/support/v7/widget/ac;->a:Landroid/support/v7/widget/ac$b;

    invoke-interface {p2}, Landroid/support/v7/widget/ac$b;->a()I
    ...
    invoke-virtual {v0, p2, p4}, Landroid/support/v7/widget/ac$a;->a(IZ)V
    ...
    :cond_1
    iget-object p4, p0, Landroid/support/v7/widget/ac;->a:Landroid/support/v7/widget/ac$b;

    invoke-interface {p4, p1, p2, p3}, Landroid/support/v7/widget/ac$b;->a(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
...
.method a(Landroid/view/View;IZ)V
    ...
    invoke-virtual {v0, p2, p3}, Landroid/support/v7/widget/ac$a;->a(IZ)V
    ...
    :cond_1
    iget-object p3, p0, Landroid/support/v7/widget/ac;->a:Landroid/support/v7/widget/ac$b;

    invoke-interface {p3, p1, p2}, Landroid/support/v7/widget/ac$b;->a(Landroid/view/View;I)V
...
.method b(Landroid/view/View;)I
    ...
    invoke-virtual {v1, p1}, Landroid/support/v7/widget/ac$a;->c(I)Z
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/ac$a;->e(I)I
...
.method c(I)Landroid/view/View;
    ...
    invoke-interface {v3, v2}, Landroid/support/v7/widget/ac$b;->b(Landroid/view/View;)Landroid/support/v7/widget/RecyclerView$x;
...
.method e(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/ac$a;->d(I)Z

    iget-object v0, p0, Landroid/support/v7/widget/ac;->a:Landroid/support/v7/widget/ac$b;

    invoke-interface {v0, p1}, Landroid/support/v7/widget/ac$b;->c(I)V
