...
.method constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/bm;->a:Landroid/support/v4/g/a;

    new-instance v0, Landroid/support/v4/g/f;

    invoke-direct {v0}, Landroid/support/v4/g/f;-><init>()V

    iput-object v0, p0, Landroid/support/v7/widget/bm;->b:Landroid/support/v4/g/f;
...
.method private a(Landroid/support/v7/widget/RecyclerView$x;I)Landroid/support/v7/widget/RecyclerView$f$c;
    ...
    iget v2, v1, Landroid/support/v7/widget/bm$a;->a:I
    ...
    iput v0, v1, Landroid/support/v7/widget/bm$a;->a:I

    const/4 v0, 0x4

    if-ne p2, v0, :cond_1

    iget-object p2, v1, Landroid/support/v7/widget/bm$a;->b:Landroid/support/v7/widget/RecyclerView$f$c;
    ...
    iget-object p2, v1, Landroid/support/v7/widget/bm$a;->c:Landroid/support/v7/widget/RecyclerView$f$c;
...
.method a(Landroid/support/v7/widget/RecyclerView$x;Landroid/support/v7/widget/RecyclerView$f$c;)V
    ...
    :cond_0
    iput-object p2, v0, Landroid/support/v7/widget/bm$a;->b:Landroid/support/v7/widget/RecyclerView$f$c;

    iget p1, v0, Landroid/support/v7/widget/bm$a;->a:I

    or-int/lit8 p1, p1, 0x4

    iput p1, v0, Landroid/support/v7/widget/bm$a;->a:I
...
.method a(Landroid/support/v7/widget/bm$b;)V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/bm;->a:Landroid/support/v4/g/a;

    invoke-virtual {v2, v0}, Landroid/support/v4/g/a;->d(I)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Landroid/support/v7/widget/bm$a;

    iget v3, v2, Landroid/support/v7/widget/bm$a;->a:I
    ...
    :goto_1
    invoke-interface {p1, v1}, Landroid/support/v7/widget/bm$b;->a(Landroid/support/v7/widget/RecyclerView$x;)V
    ...
    iget-object v3, v2, Landroid/support/v7/widget/bm$a;->b:Landroid/support/v7/widget/RecyclerView$f$c;
    ...
    iget-object v4, v2, Landroid/support/v7/widget/bm$a;->c:Landroid/support/v7/widget/RecyclerView$f$c;

    :goto_2
    invoke-interface {p1, v1, v3, v4}, Landroid/support/v7/widget/bm$b;->a(Landroid/support/v7/widget/RecyclerView$x;Landroid/support/v7/widget/RecyclerView$f$c;Landroid/support/v7/widget/RecyclerView$f$c;)V
    ...
    invoke-interface {p1, v1, v3, v4}, Landroid/support/v7/widget/bm$b;->b(Landroid/support/v7/widget/RecyclerView$x;Landroid/support/v7/widget/RecyclerView$f$c;Landroid/support/v7/widget/RecyclerView$f$c;)V
    ...
    invoke-interface {p1, v1, v3, v4}, Landroid/support/v7/widget/bm$b;->c(Landroid/support/v7/widget/RecyclerView$x;Landroid/support/v7/widget/RecyclerView$f$c;Landroid/support/v7/widget/RecyclerView$f$c;)V
    ...
    :cond_6
    iget v1, v2, Landroid/support/v7/widget/bm$a;->a:I

    :goto_4
    invoke-static {v2}, Landroid/support/v7/widget/bm$a;->a(Landroid/support/v7/widget/bm$a;)V
...
.method a(Landroid/support/v7/widget/RecyclerView$x;)Z
    ...
    check-cast p1, Landroid/support/v7/widget/bm$a;

    const/4 v0, 0x1

    if-eqz p1, :cond_0

    iget p1, p1, Landroid/support/v7/widget/bm$a;->a:I
...
.method b(Landroid/support/v7/widget/RecyclerView$x;)Landroid/support/v7/widget/RecyclerView$f$c;
    ...
    invoke-direct {p0, p1, v0}, Landroid/support/v7/widget/bm;->a(Landroid/support/v7/widget/RecyclerView$x;I)Landroid/support/v7/widget/RecyclerView$f$c;
...
.method c(Landroid/support/v7/widget/RecyclerView$x;Landroid/support/v7/widget/RecyclerView$f$c;)V
    ...
    :cond_0
    iput-object p2, v0, Landroid/support/v7/widget/bm$a;->c:Landroid/support/v7/widget/RecyclerView$f$c;
...
.method f(Landroid/support/v7/widget/RecyclerView$x;)V
    ...
    :cond_0
    iget v0, p1, Landroid/support/v7/widget/bm$a;->a:I

    and-int/lit8 v0, v0, -0x2

    iput v0, p1, Landroid/support/v7/widget/bm$a;->a:I
...
.method g(Landroid/support/v7/widget/RecyclerView$x;)V
    ...
    invoke-static {p1}, Landroid/support/v7/widget/bm$a;->a(Landroid/support/v7/widget/bm$a;)V
...
.method public h(Landroid/support/v7/widget/RecyclerView$x;)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/bm;->f(Landroid/support/v7/widget/RecyclerView$x;)V
