...
.method private static a(Landroid/animation/LayoutTransition;)V
    ...
    sput-object v2, Landroid/support/transition/ag;->d:Ljava/lang/reflect/Method;

    sget-object v2, Landroid/support/transition/ag;->d:Ljava/lang/reflect/Method;
    ...
    :goto_0
    sput-boolean v0, Landroid/support/transition/ag;->e:Z
...
.method public a(Landroid/view/ViewGroup;Z)V
    ...
    invoke-direct {v0, p0}, Landroid/support/transition/ag$1;-><init>(Landroid/support/transition/ag;)V

    sput-object v0, Landroid/support/transition/ag;->a:Landroid/animation/LayoutTransition;
    ...
    invoke-static {p2}, Landroid/support/transition/ag;->a(Landroid/animation/LayoutTransition;)V
    ...
    :cond_2
    sget-object p2, Landroid/support/transition/ag;->a:Landroid/animation/LayoutTransition;
    ...
    sget-boolean p2, Landroid/support/transition/ag;->c:Z
    ...
    sput-object p2, Landroid/support/transition/ag;->b:Ljava/lang/reflect/Field;

    sget-object p2, Landroid/support/transition/ag;->b:Ljava/lang/reflect/Field;
    ...
    :goto_1
    sput-boolean v1, Landroid/support/transition/ag;->c:Z
    ...
    :try_start_2
    sget-object v0, Landroid/support/transition/ag;->b:Ljava/lang/reflect/Field;
