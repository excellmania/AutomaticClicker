...
.method public onAnimationCancel(Landroid/animation/Animator;)V
    ...
    iput-boolean p1, p0, Landroid/support/transition/f$9;->h:Z
...
.method public onAnimationEnd(Landroid/animation/Animator;)V
    ...
    iget-boolean p1, p0, Landroid/support/transition/f$9;->h:Z

    if-nez p1, :cond_0

    iget-object p1, p0, Landroid/support/transition/f$9;->a:Landroid/view/View;

    iget-object v0, p0, Landroid/support/transition/f$9;->b:Landroid/graphics/Rect;

    invoke-static {p1, v0}, Landroid/support/v4/h/s;->a(Landroid/view/View;Landroid/graphics/Rect;)V

    iget-object p1, p0, Landroid/support/transition/f$9;->a:Landroid/view/View;

    iget v0, p0, Landroid/support/transition/f$9;->c:I

    iget v1, p0, Landroid/support/transition/f$9;->d:I

    iget v2, p0, Landroid/support/transition/f$9;->e:I

    iget v3, p0, Landroid/support/transition/f$9;->f:I
