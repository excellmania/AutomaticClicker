...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/d/a/i$f;->k:Landroid/support/v4/g/a;
...
.method public constructor <init>(Landroid/support/d/a/i$f;)V
    ...
    iget-object v2, p0, Landroid/support/d/a/i$f;->k:Landroid/support/v4/g/a;
    ...
    iget-object v1, p0, Landroid/support/d/a/i$f;->k:Landroid/support/v4/g/a;

    invoke-virtual {v1, v0, p0}, Landroid/support/v4/g/a;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_0
    iget-object p1, p1, Landroid/support/d/a/i$f;->j:Ljava/lang/Boolean;

    iput-object p1, p0, Landroid/support/d/a/i$f;->j:Ljava/lang/Boolean;
...
.method private a(Landroid/graphics/Matrix;)F
    ...
    invoke-static {p1, v3, v2, v0}, Landroid/support/d/a/i$f;->a(FFFF)F
...
.method private a(Landroid/support/d/a/i$c;Landroid/graphics/Matrix;Landroid/graphics/Canvas;IILandroid/graphics/ColorFilter;)V
    ...
    iget-object p2, p1, Landroid/support/d/a/i$c;->a:Landroid/graphics/Matrix;

    iget-object v0, p1, Landroid/support/d/a/i$c;->d:Landroid/graphics/Matrix;
    ...
    iget-object v4, p1, Landroid/support/d/a/i$c;->a:Landroid/graphics/Matrix;
    ...
    check-cast v4, Landroid/support/d/a/i$e;
    ...
    invoke-direct/range {v2 .. v8}, Landroid/support/d/a/i$f;->a(Landroid/support/d/a/i$c;Landroid/support/d/a/i$e;Landroid/graphics/Canvas;IILandroid/graphics/ColorFilter;)V
...
.method private a(Landroid/support/d/a/i$c;Landroid/support/d/a/i$e;Landroid/graphics/Canvas;IILandroid/graphics/ColorFilter;)V
    ...
    iget v0, p0, Landroid/support/d/a/i$f;->f:F

    div-float/2addr p4, v0

    int-to-float p5, p5

    iget v0, p0, Landroid/support/d/a/i$f;->g:F
    ...
    iget-object p1, p1, Landroid/support/d/a/i$c;->a:Landroid/graphics/Matrix;

    iget-object v1, p0, Landroid/support/d/a/i$f;->o:Landroid/graphics/Matrix;
    ...
    invoke-direct {p0, p1}, Landroid/support/d/a/i$f;->a(Landroid/graphics/Matrix;)F
    ...
    :cond_0
    iget-object p5, p0, Landroid/support/d/a/i$f;->l:Landroid/graphics/Path;

    invoke-virtual {p2, p5}, Landroid/support/d/a/i$e;->a(Landroid/graphics/Path;)V
    ...
    iget-object p1, p0, Landroid/support/d/a/i$f;->m:Landroid/graphics/Path;

    iget-object p2, p0, Landroid/support/d/a/i$f;->o:Landroid/graphics/Matrix;
    ...
    iget v1, p2, Landroid/support/d/a/i$b;->g:F
    ...
    iget v1, p2, Landroid/support/d/a/i$b;->h:F
    ...
    iget-object v2, p0, Landroid/support/d/a/i$f;->p:Landroid/graphics/PathMeasure;
    ...
    iput-object v2, p0, Landroid/support/d/a/i$f;->p:Landroid/graphics/PathMeasure;

    :cond_3
    iget-object v2, p0, Landroid/support/d/a/i$f;->p:Landroid/graphics/PathMeasure;

    iget-object v5, p0, Landroid/support/d/a/i$f;->l:Landroid/graphics/Path;
    ...
    iget-object v1, p0, Landroid/support/d/a/i$f;->p:Landroid/graphics/PathMeasure;
    ...
    :cond_5
    iget-object p4, p0, Landroid/support/d/a/i$f;->m:Landroid/graphics/Path;

    iget-object v1, p0, Landroid/support/d/a/i$f;->o:Landroid/graphics/Matrix;

    invoke-virtual {p4, p5, v1}, Landroid/graphics/Path;->addPath(Landroid/graphics/Path;Landroid/graphics/Matrix;)V

    iget-object p4, p2, Landroid/support/d/a/i$b;->c:Landroid/support/v4/a/a/b;
    ...
    iget-object v1, p0, Landroid/support/d/a/i$f;->b:Landroid/graphics/Paint;
    ...
    iput-object v1, p0, Landroid/support/d/a/i$f;->b:Landroid/graphics/Paint;
    ...
    iget p4, p2, Landroid/support/d/a/i$b;->f:F
    ...
    iget v2, p2, Landroid/support/d/a/i$b;->f:F

    invoke-static {p4, v2}, Landroid/support/d/a/i;->a(IF)I
    ...
    iget v2, p2, Landroid/support/d/a/i$b;->e:I
    ...
    :cond_9
    iget-object p4, p2, Landroid/support/d/a/i$b;->a:Landroid/support/v4/a/a/b;
    ...
    iget-object v1, p0, Landroid/support/d/a/i$f;->a:Landroid/graphics/Paint;
    ...
    iput-object v1, p0, Landroid/support/d/a/i$f;->a:Landroid/graphics/Paint;
    ...
    iget-object v2, p2, Landroid/support/d/a/i$b;->k:Landroid/graphics/Paint$Join;
    ...
    :cond_b
    iget-object v2, p2, Landroid/support/d/a/i$b;->j:Landroid/graphics/Paint$Cap;
    ...
    :cond_c
    iget v2, p2, Landroid/support/d/a/i$b;->l:F
    ...
    iget p4, p2, Landroid/support/d/a/i$b;->d:F
    ...
    iget p5, p2, Landroid/support/d/a/i$b;->d:F

    invoke-static {p4, p5}, Landroid/support/d/a/i;->a(IF)I
    ...
    iget p1, p2, Landroid/support/d/a/i$b;->b:F
...
.method public setAlpha(F)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/d/a/i$f;->setRootAlpha(I)V
