...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget-object v2, Landroid/support/design/a$j;->ForegroundLinearLayout:[I

    invoke-virtual {p1, p2, v2, p3, v1}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;

    move-result-object p1

    sget p2, Landroid/support/design/a$j;->ForegroundLinearLayout_android_foregroundGravity:I
    ...
    sget p2, Landroid/support/design/a$j;->ForegroundLinearLayout_android_foreground:I
    ...
    :cond_0
    sget p2, Landroid/support/design/a$j;->ForegroundLinearLayout_foregroundInsidePadding:I
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-super {p0, p1}, Landroid/support/v7/widget/an;->draw(Landroid/graphics/Canvas;)V
...
.method public drawableHotspotChanged(FF)V
    ...
    invoke-super {p0, p1, p2}, Landroid/support/v7/widget/an;->drawableHotspotChanged(FF)V
...
.method protected drawableStateChanged()V
    ...
    invoke-super {p0}, Landroid/support/v7/widget/an;->drawableStateChanged()V
...
.method public jumpDrawablesToCurrentState()V
    ...
    invoke-super {p0}, Landroid/support/v7/widget/an;->jumpDrawablesToCurrentState()V
...
.method protected onSizeChanged(IIII)V
    ...
    invoke-super {p0, p1, p2, p3, p4}, Landroid/support/v7/widget/an;->onSizeChanged(IIII)V
...
.method protected verifyDrawable(Landroid/graphics/drawable/Drawable;)Z
    ...
    invoke-super {p0, p1}, Landroid/support/v7/widget/an;->verifyDrawable(Landroid/graphics/drawable/Drawable;)Z
