...
.method final a()I
    ...
    iget v0, p0, Landroid/support/design/widget/h;->c:I
...
.method public a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;IIII)Z
    ...
    invoke-virtual {p0, v3}, Landroid/support/design/widget/h;->b(Ljava/util/List;)Landroid/view/View;

    move-result-object v3

    if-eqz v3, :cond_5

    invoke-static {v3}, Landroid/support/v4/h/s;->o(Landroid/view/View;)Z
    ...
    invoke-static {p2, v5}, Landroid/support/v4/h/s;->b(Landroid/view/View;Z)V
    ...
    invoke-virtual {p0, v3}, Landroid/support/design/widget/h;->b(Landroid/view/View;)I
...
.method public final b(I)V
    ...
    iput p1, p0, Landroid/support/design/widget/h;->d:I
...
.method protected b(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;I)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/design/widget/h;->b(Ljava/util/List;)Landroid/view/View;
    ...
    invoke-virtual {p1}, Landroid/support/design/widget/CoordinatorLayout;->getLastWindowInsets()Landroid/support/v4/h/aa;
    ...
    invoke-static {v1}, Landroid/support/design/widget/h;->c(I)I
    ...
    invoke-static/range {v2 .. v7}, Landroid/support/v4/h/e;->a(IIILandroid/graphics/Rect;Landroid/graphics/Rect;I)V

    invoke-virtual {p0, v0}, Landroid/support/design/widget/h;->c(Landroid/view/View;)I
    ...
    :cond_1
    invoke-super {p0, p1, p2, p3}, Landroid/support/design/widget/n;->b(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;I)V
...
.method final c(Landroid/view/View;)I
    ...
    :cond_0
    invoke-virtual {p0, p1}, Landroid/support/design/widget/h;->a(Landroid/view/View;)F
