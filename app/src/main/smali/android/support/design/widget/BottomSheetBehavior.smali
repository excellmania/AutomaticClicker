...
.field e:Landroid/support/v4/widget/p;
...
.field private final v:Landroid/support/v4/widget/p$a;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/design/widget/BottomSheetBehavior;->v:Landroid/support/v4/widget/p$a;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v0, Landroid/support/design/a$j;->BottomSheetBehavior_Layout_behavior_peekHeight:I
    ...
    sget v0, Landroid/support/design/a$j;->BottomSheetBehavior_Layout_behavior_hideable:I
    ...
    sget v0, Landroid/support/design/a$j;->BottomSheetBehavior_Layout_behavior_skipCollapsed:I
...
.method a(Landroid/view/View;)Landroid/view/View;
    ...
    invoke-static {p1}, Landroid/support/v4/h/s;->t(Landroid/view/View;)Z
...
.method public a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;II[I)V
    ...
    invoke-static {p2, p1}, Landroid/support/v4/h/s;->b(Landroid/view/View;I)V
    ...
    iget-boolean p4, p0, Landroid/support/design/widget/BottomSheetBehavior;->c:Z
...
.method public a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;I)Z
    ...
    invoke-static {p2}, Landroid/support/v4/h/s;->o(Landroid/view/View;)Z

    move-result v0

    if-nez v0, :cond_0

    invoke-static {p2, v1}, Landroid/support/v4/h/s;->b(Landroid/view/View;Z)V
    ...
    :goto_1
    invoke-static {p2, p3}, Landroid/support/v4/h/s;->b(Landroid/view/View;I)V
    ...
    invoke-static {p2, v0}, Landroid/support/v4/h/s;->b(Landroid/view/View;I)V

    :cond_7
    :goto_2
    iget-object p3, p0, Landroid/support/design/widget/BottomSheetBehavior;->e:Landroid/support/v4/widget/p;

    if-nez p3, :cond_8

    iget-object p3, p0, Landroid/support/design/widget/BottomSheetBehavior;->v:Landroid/support/v4/widget/p$a;

    invoke-static {p1, p3}, Landroid/support/v4/widget/p;->a(Landroid/view/ViewGroup;Landroid/support/v4/widget/p$a;)Landroid/support/v4/widget/p;

    move-result-object p1

    iput-object p1, p0, Landroid/support/design/widget/BottomSheetBehavior;->e:Landroid/support/v4/widget/p;
...
.method public a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    iget-object p2, p0, Landroid/support/design/widget/BottomSheetBehavior;->e:Landroid/support/v4/widget/p;

    invoke-virtual {p2, p3}, Landroid/support/v4/widget/p;->a(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {p2}, Landroid/support/v4/widget/p;->a()I
...
.method public b(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    :cond_1
    iget-object v0, p0, Landroid/support/design/widget/BottomSheetBehavior;->e:Landroid/support/v4/widget/p;
    ...
    iget-object p1, p0, Landroid/support/design/widget/BottomSheetBehavior;->e:Landroid/support/v4/widget/p;
    ...
    invoke-virtual {p1, p2, p3}, Landroid/support/v4/widget/p;->a(Landroid/view/View;I)V
...
.method public c(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)V
    ...
    invoke-virtual {p3, p2, v0, p1}, Landroid/support/v4/widget/p;->a(Landroid/view/View;II)Z
    ...
    invoke-static {p2, p1}, Landroid/support/v4/h/s;->a(Landroid/view/View;Ljava/lang/Runnable;)V
