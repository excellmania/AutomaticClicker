...
.field private t:Landroid/support/v4/h/aa;

.field private u:Z

.field private v:Landroid/graphics/drawable/Drawable;

.field private w:Landroid/support/v4/h/q;

.field private final x:Landroid/support/v4/h/p;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/h/p;-><init>(Landroid/view/ViewGroup;)V

    iput-object v0, p0, Landroid/support/design/widget/CoordinatorLayout;->x:Landroid/support/v4/h/p;
...
.method private a(Landroid/view/View;ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/support/design/widget/CoordinatorLayout$e;II)V
    ...
    invoke-static {p1, p2}, Landroid/support/v4/h/e;->a(II)I
    ...
    invoke-static {p5, p2}, Landroid/support/v4/h/e;->a(II)I
...
.method private a(Landroid/view/View;Landroid/graphics/Rect;I)V
    ...
    invoke-static {p1}, Landroid/support/v4/h/s;->v(Landroid/view/View;)Z
    ...
    invoke-static {v1, p3}, Landroid/support/v4/h/e;->a(II)I
...
.method private b(Landroid/support/v4/h/aa;)Landroid/support/v4/h/aa;
    .locals 4

    invoke-virtual {p1}, Landroid/support/v4/h/aa;->e()Z
    ...
    invoke-static {v2}, Landroid/support/v4/h/s;->o(Landroid/view/View;)Z
    ...
    invoke-virtual {v3, p0, v2, p1}, Landroid/support/design/widget/CoordinatorLayout$b;->a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/support/v4/h/aa;)Landroid/support/v4/h/aa;
...
.method private d(Landroid/view/View;I)V
    ...
    iget-object v1, p0, Landroid/support/design/widget/CoordinatorLayout;->t:Landroid/support/v4/h/aa;

    if-eqz v1, :cond_0

    invoke-static {p0}, Landroid/support/v4/h/s;->o(Landroid/view/View;)Z

    move-result v1

    if-eqz v1, :cond_0

    invoke-static {p1}, Landroid/support/v4/h/s;->o(Landroid/view/View;)Z
    ...
    iget-object v2, p0, Landroid/support/design/widget/CoordinatorLayout;->t:Landroid/support/v4/h/aa;

    invoke-virtual {v2}, Landroid/support/v4/h/aa;->a()I
    ...
    invoke-virtual {v2}, Landroid/support/v4/h/aa;->b()I
    ...
    invoke-virtual {v2}, Landroid/support/v4/h/aa;->c()I
    ...
    invoke-virtual {v2}, Landroid/support/v4/h/aa;->d()I
    ...
    invoke-static/range {v1 .. v6}, Landroid/support/v4/h/e;->a(IIILandroid/graphics/Rect;Landroid/graphics/Rect;I)V
...
.method private e(Landroid/view/View;I)V
    ...
    invoke-static {p1, v1}, Landroid/support/v4/h/s;->c(Landroid/view/View;I)V
...
.method private f(Landroid/view/View;I)V
    ...
    invoke-static {p1, v1}, Landroid/support/v4/h/s;->b(Landroid/view/View;I)V
...
.method private g()V
    ...
    iget-object v0, p0, Landroid/support/design/widget/CoordinatorLayout;->w:Landroid/support/v4/h/q;
    ...
    iput-object v0, p0, Landroid/support/design/widget/CoordinatorLayout;->w:Landroid/support/v4/h/q;

    :cond_1
    iget-object v0, p0, Landroid/support/design/widget/CoordinatorLayout;->w:Landroid/support/v4/h/q;

    invoke-static {p0, v0}, Landroid/support/v4/h/s;->a(Landroid/view/View;Landroid/support/v4/h/q;)V
...
.method final a(Landroid/support/v4/h/aa;)Landroid/support/v4/h/aa;
    .locals 3

    iget-object v0, p0, Landroid/support/design/widget/CoordinatorLayout;->t:Landroid/support/v4/h/aa;
    ...
    iput-object p1, p0, Landroid/support/design/widget/CoordinatorLayout;->t:Landroid/support/v4/h/aa;
    ...
    invoke-virtual {p1}, Landroid/support/v4/h/aa;->b()I
    ...
    invoke-direct {p0, p1}, Landroid/support/design/widget/CoordinatorLayout;->b(Landroid/support/v4/h/aa;)Landroid/support/v4/h/aa;
...
.method final a(I)V
    ...
    invoke-static {v12, v2}, Landroid/support/v4/h/e;->a(II)I
...
.method public a(Landroid/view/View;II[II)V
    ...
    invoke-virtual {v1, v15}, Landroid/support/design/widget/CoordinatorLayout$e;->b(I)Z
    ...
    iget-object v1, v8, Landroid/support/design/widget/CoordinatorLayout;->k:[I
...
.method a(Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    invoke-static {p0, p1, p2}, Landroid/support/v4/widget/q;->b(Landroid/view/ViewGroup;Landroid/view/View;Landroid/graphics/Rect;)V
...
.method b(Landroid/view/View;I)V
    ...
    invoke-static {v9, v0}, Landroid/support/v4/h/s;->c(Landroid/view/View;I)V

    :cond_2
    if-eqz v1, :cond_3

    invoke-static {v9, v1}, Landroid/support/v4/h/s;->b(Landroid/view/View;I)V
...
.method public b(Landroid/view/View;Landroid/view/View;II)V
    ...
    iget-object v0, p0, Landroid/support/design/widget/CoordinatorLayout;->x:Landroid/support/v4/h/p;

    invoke-virtual {v0, p1, p2, p3, p4}, Landroid/support/v4/h/p;->a(Landroid/view/View;Landroid/view/View;II)V
...
.method public c(Landroid/view/View;I)V
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v4/h/p;->a(Landroid/view/View;I)V
...
.method public final getLastWindowInsets()Landroid/support/v4/h/aa;
    .locals 1
...
.method public getNestedScrollAxes()I
    ...
    invoke-virtual {v0}, Landroid/support/v4/h/p;->a()I
...
.method public onAttachedToWindow()V
    ...
    invoke-static {p0}, Landroid/support/v4/h/s;->n(Landroid/view/View;)V
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {v0}, Landroid/support/v4/h/aa;->b()I
...
.method protected onLayout(ZIIII)V
    ...
    invoke-static {p0}, Landroid/support/v4/h/s;->e(Landroid/view/View;)I
...
.method protected onMeasure(II)V
    ...
    iget-object v3, v7, Landroid/support/design/widget/CoordinatorLayout;->t:Landroid/support/v4/h/aa;

    if-eqz v3, :cond_1

    invoke-static/range {p0 .. p0}, Landroid/support/v4/h/s;->o(Landroid/view/View;)Z
    ...
    invoke-static {v11, v10}, Landroid/support/v4/h/e;->a(II)I
    ...
    invoke-static/range {v20 .. v20}, Landroid/support/v4/h/s;->o(Landroid/view/View;)Z

    move-result v0

    if-nez v0, :cond_a

    iget-object v0, v7, Landroid/support/design/widget/CoordinatorLayout;->t:Landroid/support/v4/h/aa;

    invoke-virtual {v0}, Landroid/support/v4/h/aa;->a()I

    move-result v0

    iget-object v2, v7, Landroid/support/design/widget/CoordinatorLayout;->t:Landroid/support/v4/h/aa;
    ...
    iget-object v11, v7, Landroid/support/design/widget/CoordinatorLayout;->t:Landroid/support/v4/h/aa;

    invoke-virtual {v11}, Landroid/support/v4/h/aa;->d()I
