...
.method public constructor <init>(Landroid/content/Context;Landroid/graphics/drawable/Drawable;FFF)V
    ...
    invoke-direct {p0, p2}, Landroid/support/v7/c/a/c;-><init>(Landroid/graphics/drawable/Drawable;)V

    const/4 p2, 0x1

    iput-boolean p2, p0, Landroid/support/design/widget/i;->k:Z

    iput-boolean p2, p0, Landroid/support/design/widget/i;->o:Z

    const/4 p2, 0x0

    iput-boolean p2, p0, Landroid/support/design/widget/i;->q:Z
    ...
    iput v0, p0, Landroid/support/design/widget/i;->l:I
    ...
    iput v0, p0, Landroid/support/design/widget/i;->m:I
    ...
    iput-object p1, p0, Landroid/support/design/widget/i;->b:Landroid/graphics/Paint;

    iget-object p1, p0, Landroid/support/design/widget/i;->b:Landroid/graphics/Paint;
    ...
    iput p1, p0, Landroid/support/design/widget/i;->e:F

    new-instance p1, Landroid/graphics/RectF;

    invoke-direct {p1}, Landroid/graphics/RectF;-><init>()V

    iput-object p1, p0, Landroid/support/design/widget/i;->d:Landroid/graphics/RectF;

    new-instance p1, Landroid/graphics/Paint;

    iget-object p3, p0, Landroid/support/design/widget/i;->b:Landroid/graphics/Paint;

    invoke-direct {p1, p3}, Landroid/graphics/Paint;-><init>(Landroid/graphics/Paint;)V

    iput-object p1, p0, Landroid/support/design/widget/i;->c:Landroid/graphics/Paint;

    iget-object p1, p0, Landroid/support/design/widget/i;->c:Landroid/graphics/Paint;

    invoke-virtual {p1, p2}, Landroid/graphics/Paint;->setAntiAlias(Z)V

    invoke-virtual {p0, p4, p5}, Landroid/support/design/widget/i;->a(FF)V
...
.method private a(Landroid/graphics/Canvas;)V
    ...
    iget v1, v0, Landroid/support/design/widget/i;->p:F
    ...
    iget-object v12, v0, Landroid/support/design/widget/i;->c:Landroid/graphics/Paint;
...
.method private a(Landroid/graphics/Rect;)V
    ...
    iget-object v1, p0, Landroid/support/design/widget/i;->d:Landroid/graphics/RectF;

    iget v2, p1, Landroid/graphics/Rect;->left:I

    int-to-float v2, v2

    iget v3, p0, Landroid/support/design/widget/i;->h:F
    ...
    invoke-virtual {p0}, Landroid/support/design/widget/i;->b()Landroid/graphics/drawable/Drawable;

    move-result-object p1

    iget-object v0, p0, Landroid/support/design/widget/i;->d:Landroid/graphics/RectF;
    ...
    iget-object v2, p0, Landroid/support/design/widget/i;->d:Landroid/graphics/RectF;

    iget v2, v2, Landroid/graphics/RectF;->right:F

    float-to-int v2, v2

    iget-object v3, p0, Landroid/support/design/widget/i;->d:Landroid/graphics/RectF;
    ...
    invoke-direct {p0}, Landroid/support/design/widget/i;->c()V
...
.method private c()V
    ...
    iget v2, v0, Landroid/support/design/widget/i;->e:F
    ...
    iget-object v3, v0, Landroid/support/design/widget/i;->f:Landroid/graphics/Path;
    ...
    iput-object v3, v0, Landroid/support/design/widget/i;->f:Landroid/graphics/Path;
    ...
    iget v4, v0, Landroid/support/design/widget/i;->e:F
    ...
    iget v4, v0, Landroid/support/design/widget/i;->i:F
    ...
    iget-object v14, v0, Landroid/support/design/widget/i;->b:Landroid/graphics/Paint;
    ...
    iget v8, v0, Landroid/support/design/widget/i;->l:I

    aput v8, v10, v6

    iget v8, v0, Landroid/support/design/widget/i;->m:I

    aput v8, v10, v4

    iget v8, v0, Landroid/support/design/widget/i;->n:I
    ...
    iget v6, v0, Landroid/support/design/widget/i;->n:I
...
.method a(FF)V
    ...
    invoke-static {p1}, Landroid/support/design/widget/i;->c(F)I

    move-result p1

    int-to-float p1, p1

    invoke-static {p2}, Landroid/support/design/widget/i;->c(F)I
    ...
    iget-boolean p1, p0, Landroid/support/design/widget/i;->q:Z

    if-nez p1, :cond_0

    iput-boolean v1, p0, Landroid/support/design/widget/i;->q:Z
    ...
    iput-boolean v1, p0, Landroid/support/design/widget/i;->k:Z
...
.method public a(Z)V
    ...
    iput-boolean p1, p0, Landroid/support/design/widget/i;->o:Z
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-boolean v0, p0, Landroid/support/design/widget/i;->k:Z

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Landroid/support/design/widget/i;->getBounds()Landroid/graphics/Rect;

    move-result-object v0

    invoke-direct {p0, v0}, Landroid/support/design/widget/i;->a(Landroid/graphics/Rect;)V

    const/4 v0, 0x0

    iput-boolean v0, p0, Landroid/support/design/widget/i;->k:Z

    :cond_0
    invoke-direct {p0, p1}, Landroid/support/design/widget/i;->a(Landroid/graphics/Canvas;)V
...
.method public getPadding(Landroid/graphics/Rect;)Z
    ...
    iget-boolean v2, p0, Landroid/support/design/widget/i;->o:Z
    ...
    iget-boolean v3, p0, Landroid/support/design/widget/i;->o:Z
...
.method protected onBoundsChange(Landroid/graphics/Rect;)V
    ...
    iput-boolean p1, p0, Landroid/support/design/widget/i;->k:Z
