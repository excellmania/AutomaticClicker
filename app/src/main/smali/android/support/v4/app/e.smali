...
.method public constructor <init>(Landroid/support/v4/app/d;)V
    ...
    iget-object v3, p1, Landroid/support/v4/app/d;->b:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, Landroid/support/v4/app/e;->a:[I
...
# virtual methods
.method public a(Landroid/support/v4/app/m;)Landroid/support/v4/app/d;
    .locals 7
    ...
    iput v1, v3, Landroid/support/v4/app/d$a;->a:I
    ...
    iget-object v6, p0, Landroid/support/v4/app/e;->a:[I
    ...
    :goto_1
    iput-object v1, v3, Landroid/support/v4/app/d$a;->b:Landroid/support/v4/app/g;
    ...
    iput v4, v3, Landroid/support/v4/app/d$a;->c:I

    add-int/lit8 v4, v5, 0x1

    aget v5, v1, v5

    iput v5, v3, Landroid/support/v4/app/d$a;->d:I

    add-int/lit8 v5, v4, 0x1

    aget v4, v1, v4

    iput v4, v3, Landroid/support/v4/app/d$a;->e:I

    add-int/lit8 v4, v5, 0x1

    aget v1, v1, v5

    iput v1, v3, Landroid/support/v4/app/d$a;->f:I

    iget v1, v3, Landroid/support/v4/app/d$a;->c:I

    iput v1, v0, Landroid/support/v4/app/d;->c:I

    iget v1, v3, Landroid/support/v4/app/d$a;->d:I

    iput v1, v0, Landroid/support/v4/app/d;->d:I

    iget v1, v3, Landroid/support/v4/app/d$a;->e:I

    iput v1, v0, Landroid/support/v4/app/d;->e:I

    iget v1, v3, Landroid/support/v4/app/d$a;->f:I

    iput v1, v0, Landroid/support/v4/app/d;->f:I
    ...
    iput p1, v0, Landroid/support/v4/app/d;->g:I

    iget p1, p0, Landroid/support/v4/app/e;->c:I

    iput p1, v0, Landroid/support/v4/app/d;->h:I

    iget-object p1, p0, Landroid/support/v4/app/e;->d:Ljava/lang/String;

    iput-object p1, v0, Landroid/support/v4/app/d;->k:Ljava/lang/String;

    iget p1, p0, Landroid/support/v4/app/e;->e:I

    iput p1, v0, Landroid/support/v4/app/d;->m:I

    const/4 p1, 0x1

    iput-boolean p1, v0, Landroid/support/v4/app/d;->i:Z
    ...
    iput-object v1, v0, Landroid/support/v4/app/d;->o:Ljava/lang/CharSequence;

    iget v1, p0, Landroid/support/v4/app/e;->h:I

    iput v1, v0, Landroid/support/v4/app/d;->p:I

    iget-object v1, p0, Landroid/support/v4/app/e;->i:Ljava/lang/CharSequence;

    iput-object v1, v0, Landroid/support/v4/app/d;->q:Ljava/lang/CharSequence;

    iget-object v1, p0, Landroid/support/v4/app/e;->j:Ljava/util/ArrayList;

    iput-object v1, v0, Landroid/support/v4/app/d;->r:Ljava/util/ArrayList;

    iget-object v1, p0, Landroid/support/v4/app/e;->k:Ljava/util/ArrayList;

    iput-object v1, v0, Landroid/support/v4/app/d;->s:Ljava/util/ArrayList;

    iget-boolean v1, p0, Landroid/support/v4/app/e;->l:Z

    iput-boolean v1, v0, Landroid/support/v4/app/d;->t:Z

    invoke-virtual {v0, p1}, Landroid/support/v4/app/d;->a(I)V
